...
export default function Content({onAddProject}) // Gets passed a state fn to add a new Project to the App
{
    return (
        <main className="h-screen text-center flex flex-col justify-center">
            ...
            <button className="self-center inline-block w-40 h-10 bg-stone-700 text-stone-400 hover:bg-stone-500 hover:text-stone-300 font-semibold rounded-lg mt-4" onClick={onAddProject}>Create new project</button>
        </main>
    )
}