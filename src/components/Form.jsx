...
{
    return (
        <form onSubmit={(e) => onFormSubmit(e, formData)} className="flex flex-wrap justify-start pe-10 xl:pe-[56rem] pt-36">
            ...
            <div className="grid grid-cols-1 ps-12">
                ...
                <Input label="title" data={formData} onInputChange={onFormChange}/>
                <Input label="description" data={formData} onInputChange={onFormChange} isTextArea/>
                <Input label="due date" data={formData} onInputChange={onFormChange}/>
