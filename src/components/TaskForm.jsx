...
export default function TaskForm({task, onTaskChange, onTaskSubmit, taskData, onTaskDelete})
{
    return (
        <form onSubmit={onTaskSubmit} className="pt-8 ps-96 pe-60">
            ...
            <div>
                <input type="text" className="bg-neutral-200 me-3 p-1 rounded border-b-2 border-stone-300 focus:outline-none" value={task} onChange={onTaskChange} required/>
                <button className="text-zinc-900 hover:text-zinc-700">Add Task</button>
            </div>
